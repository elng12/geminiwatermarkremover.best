// ../../../../private/tmp/gemini-watermark-remover-review/src/core/embeddedAlphaMaps.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/blendModes.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/geminiSizeCatalog.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/adaptiveDetector.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/restorationMetrics.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/multiPassRemoval.js
var DEFAULT_MAX_PASSES = 5;
var DEFAULT_RESIDUAL_THRESHOLD = 0.18;
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/watermarkDecisionPolicy.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/watermarkPresence.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/candidateSelector.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/selectionDebug.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/watermarkConfig.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/watermarkProcessor.js
var RESIDUAL_RECALIBRATION_THRESHOLD = 0.3;
var MIN_SUPPRESSION_FOR_SKIP_RECALIBRATION = 0.28;
var MIN_RECALIBRATION_SCORE_DELTA = 0.08;
var MAX_NEAR_BLACK_RATIO_INCREASE3 = 0.05;
var OUTLINE_REFINEMENT_THRESHOLD = 0.28;
var OUTLINE_REFINEMENT_MIN_GAIN = 1.12;
var SUBPIXEL_REFINE_SHIFTS = [-0.25, 0, 0.25];
var SUBPIXEL_REFINE_SCALES = [0.99, 1, 1.01];
var ALPHA_GAIN_CANDIDATES = [1.05, 1.12, 1.2, 1.28, 1.36, 1.45, 1.52, 1.6, 1.7, 1.85, 2, 2.2, 2.4, 2.6, 2.8, 3];
var PREVIEW_EDGE_CLEANUP_MAX_SIZE = 112;
var PREVIEW_EDGE_CLEANUP_SPATIAL_THRESHOLD = 0.16;
var PREVIEW_EDGE_CLEANUP_GRADIENT_THRESHOLD = 0.06;
var PREVIEW_EDGE_CLEANUP_MIN_GRADIENT_IMPROVEMENT = 0.015;
var PREVIEW_EDGE_CLEANUP_MAX_SPATIAL_DRIFT = 0.08;
var PREVIEW_EDGE_CLEANUP_MAX_APPLIED_PASSES = 4;
...
var PREVIEW_EDGE_CLEANUP_MIN_HALO_REDUCTION = 0.6;
var PREVIEW_EDGE_CLEANUP_STRONG_HALO_THRESHOLD = 2.2;
var PREVIEW_EDGE_CLEANUP_HALO_SPATIAL_THRESHOLD = 0.24;
...
function shouldRecalibrateAlphaStrength({ originalScore, processedScore, suppressionGain }) {
  return originalScore >= 0.45 && processedScore >= RESIDUAL_RECALIBRATION_THRESHOLD && suppressionGain <= MIN_SUPPRESSION_FOR_SKIP_RECALIBRATION;
}
function shouldStopAfterFirstPass({
  ...
  if (Math.abs(firstPassSpatialScore) <= 0.18 && firstPassGradientScore <= 0.08) {
    return true;
  }
...
function shouldRefinePreviewResidualEdge({
  ...
  if (typeof window !== "undefined" && window.__SKIP_GEMINI_BLUR_FALLBACK) return false;
  const eligibleSource = typeof source === "string" && (source.includes("preview-anchor") || source.includes("standard") || source.includes("adaptive"));
  return eligibleSource && position?.width >= 24 && position?.width <= PREVIEW_EDGE_CLEANUP_MAX_SIZE && (Math.abs(baselineSpatialScore) <= PREVIEW_EDGE_CLEANUP_SPATIAL_THRESHOLD || baselinePositiveHalo >= PREVIEW_EDGE_CLEANUP_STRONG_HALO_THRESHOLD && Math.abs(baselineSpatialScore) <= PREVIEW_EDGE_CLEANUP_HALO_SPATIAL_THRESHOLD) && baselineGradientScore >= PREVIEW_EDGE_CLEANUP_GRADIENT_THRESHOLD;
}
function shouldUsePreviewAnchorFastCleanup(selectedTrial, position) {
  return selectedTrial?.provenance?.previewAnchor === true && position?.width >= 24 && position?.width <= 40;
}
...
function processWatermarkImageData(imageData, options = {}) {
  ...
  const skipPreviewAnchorMultiPass = selectedTrial?.provenance?.previewAnchor === true && position?.width <= 40;
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/core/watermarkEngine.js
...
// ../../../../private/tmp/gemini-watermark-remover-review/src/sdk/browser.js
